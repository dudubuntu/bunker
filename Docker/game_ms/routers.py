...
def setup_routers(app: web.Application):
    ...
    app.router.add_route('GET', '/api/v1/player_open_chars', player_open_chars)
    app.router.add_route('GET', '/api/v1/player_make_vote', player_make_vote)
    
    app.router.add_route('GET', '/api/v1/game_start', game_start)
    app.router.add_route('GET', '/api/v1/game_info', game_info)
    app.router.add_route('GET', '/api/v1/game_results', game_results)